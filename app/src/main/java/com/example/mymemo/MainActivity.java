...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            // rewQueryというSERECT専用メソッドを使用してデータを取得する
        ...
        final SimpleAdapter simpleAdapter = new SimpleAdapter(this,
                ...
                new int[] {android.R.id.text1,android.R.id.text2} //どのidの項目を入れるか
    );
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // インテント作成　第二引数にはパッケージ名からの指名で、遷移先クラスを指定
                Intent intent = new Intent(MainActivity.this, com.example.mymemo.CreateMemoActivity.class);
                ...
                TextView idView = (TextView) two.getText2();
                String idStr = (String) idTextView.getText();

                //値を引き渡す(識別名、値)の順で指定します
